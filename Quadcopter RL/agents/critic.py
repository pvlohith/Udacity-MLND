...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=400, kernel_regularizer=layers.regularizers.l2(0.01))(net_states)

        # Add hidden layer(s) for action pathway
        net_actions = layers.Dense(units=400,kernel_regularizer=layers.regularizers.l2(0.01))(actions)
